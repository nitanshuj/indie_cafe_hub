...
function Login() {
  ...
  return (
    <AuthSplit side="left">
      ...
      <p className="text-xs uppercase tracking-[0.2em] font-semibold text-[#E67E6B] font-work-sans">Welcome back</p>
      <h1 className="mt-3 text-4xl tracking-tight font-light text-[#2D2422] font-outfit">Sign in</h1>
      ...
      <p className="mt-8 text-sm text-[#6B5C58] font-work-sans">
        New here?{" "}
        <Link to="/signup" className="text-[#E67E6B] hover:text-[#D96C5A] font-medium" data-testid="login-to-signup-link">
          Create an account
        </Link>
      </p>
    </AuthSplit>
